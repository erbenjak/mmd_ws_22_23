...
def main():
    ...
    # [('a', (1, 2)), ('a', (1, 3))]
    print("One can observe that the first values of x is combined with each value from the second \n")
    ...
    print("For this purpose the combined rdd from above will be used")
    print("First:")
